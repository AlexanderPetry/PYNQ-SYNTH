...
# 2 "<built-in>" 2
# 1 "echo.cpp" 2
__attribute__((sdx_kernel("echo_effect", 0))) void echo_effect(float sample_in, float* sample_out, float delay_ms, float feedback_gain, int sample_rate,
                 volatile float* buffer, int* index) {
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=echo_effect
# 2 "echo.cpp"
