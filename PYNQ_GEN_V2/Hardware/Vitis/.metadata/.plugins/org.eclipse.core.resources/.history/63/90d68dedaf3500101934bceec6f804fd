...
#define __UART_DELAY__ usleep(1000);

#define EFFECT_AMOUNT 4
constexpr int DELAY_MAXMS = 1000;
constexpr int SAMPLE_RATE = 48000;
constexpr size_t DELAY_BUF_SIZE ((DELAY_MAXMS * SAMPLE_RATE) / 1000);

typedef float float32_t;
typedef void (*Eff_CB)(float32_t sample, void* params);
