...
#define PACKEDARRAY
static char PACKEDB[4*INNER_BLOCK*DC] __attribute__((aligned(16))); //__ALIGNED(16) char PACKEDB[4*INNER_BLOCK*DC];
static char PACKEDA[4*ROWS_BLOCK*INNER_BLOCK] __attribute__((aligned(16)));//__ALIGNED(16) char PACKEDA[4*ROWS_BLOCK*INNER_BLOCK];
static char PACKEDC[8*ROWS_BLOCK*COLS_BLOCK] __attribute__((aligned(16)));//__ALIGNED(16) char PACKEDC[8*ROWS_BLOCK*COLS_BLOCK];
#endif
